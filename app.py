...
def storage():
    ...
    if _foto.filename!='': #existe el nombre del archivo en la carpeta? 
        nuevoNombreFoto=tiempo+_foto.filename #Concateno fecha + nombre
        _foto.save("uploads/"+nuevoNombreFoto)
        # _foto.save("SistemaEmpleados/uploads/"+nuevoNombreFoto) #Pablo.
